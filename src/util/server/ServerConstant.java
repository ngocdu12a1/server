...
public class ServerConstant {
    ...
    public static final String ATTACK_MAP_INFO = "attack_map_info";

    public static final int MAP_X = 42;
    public static final int MAP_Y = 42;

    public static final int BORDER_X = 2;
    public static final int BORDER_Y = 2;

    public static final int MAP_GRASS = -1;
    public static final int MAP_RUIN = -2;
    public static final int MAP_UNAVAILABLE = -3;

    public static final int MAX_CAMPAIGN = 10;

    public static final int TICK_LENGTH = 25;

    public static final int GRASS_TILE_WIDTH = 76;
    public static final int GRASS_TILE_HEIGHT = 57;
    public static final Point ROOT_TILE_POS = new Point(20, -22);
